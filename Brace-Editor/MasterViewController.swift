...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate, PopViewControllerDelegate {
    ...
    func modal(sender: AnyObject) {
        ...
        self.popupViewController!.modalPresentationStyle = .FullScreen
        
        self.popupViewController!.preferredContentSize = CGSize(width:self.view.frame.width * CGFloat(1 / 100.0), height:self.view.frame.height * CGFloat(1 / 100.0))
    ...
    func insertNewObject(sender: [String?]) {
        ...
        let title: String = sender[0]!
        let language: String = sender[1]!
